    ...
    { id:"r1", emoji:"🧱", nome:"Rodada 1 — Tecido epitelial",
      ...
      questoes:[
        {p:"Por que o tecido epitelial não possui vasos sanguíneos?",
         alt:["É avascular: nutre-se por difusão a partir do conjuntivo subjacente","Porque suas células não precisam de nutrientes","Porque os vasos ficam na superfície apical","Porque a renovação celular é rápida demais para permitir vasos"],
        ...
        {p:"Qual é a principal diferença entre uma glândula exócrina e uma endócrina?",
         alt:["A exócrina mantém o ducto; a endócrina o perde","A exócrina é unicelular e a endócrina, multicelular","A exócrina vem do ectoderma e a endócrina do endoderma","A exócrina armazena secreção e a endócrina nunca armazena"],
        ...
        {p:"O que significa dizer que as células epiteliais apresentam polaridade?",
         alt:["Apical e basal têm estruturas distintas","Elas possuem carga elétrica de repouso invertida","Elas se dividem sempre no mesmo eixo","Elas migram sempre em direção à membrana basal"],
        ...
        {p:"O que caracteriza uma glândula endócrina folicular em comparação com uma cordonal?",
         alt:["A folicular armazena a secreção antes de liberá-la","A folicular mantém o ducto de origem","A cordonal libera sua secreção na superfície do epitélio","A cordonal é sempre unicelular"],
    ...
    { id:"r2", emoji:"🕸️", nome:"Rodada 2 — Tecido conjuntivo",
      ...
      questoes:[
        ...
        {p:"Qual das funções abaixo NÃO é atribuída à substância fundamental amorfa?",
         alt:["Conduzir impulsos nervosos no conjuntivo","Servir de veículo para a passagem de células e moléculas","Atuar como barreira a micro-organismos","Conferir compressibilidade ao tecido"],
        ...
        {p:"Como se classifica o tecido conjuntivo encontrado na artéria do cordão umbilical?",
         alt:["Tecido conjuntivo mucoso, embrionário","Tecido conjuntivo denso modelado elástico","Tecido reticular do baço","Tecido adiposo pardo multilocular"],
    ...
    { id:"r3", emoji:"🦻", nome:"Rodada 3 — Tecido cartilaginoso",
      ...
      questoes:[
        {p:"Por que a cartilagem não possui vasos sanguíneos e como ela se nutre?",
         alt:["A nutrição vem por difusão do pericôndrio","Ela possui capilares finos demais para serem vistos ao microscópio óptico","Ela é nutrida diretamente pelo osso subjacente","Os condrócitos produzem seus próprios nutrientes por fotossíntese"],
        ...
        {p:"Qual é a diferença entre condroblasto e condrócito?",
         alt:["O condroblasto produz a matriz; o condrócito fica preso nela","O condroblasto reabsorve a matriz; o condrócito a produz","O condroblasto é multinucleado; o condrócito é uninucleado","O condroblasto pertence ao pericôndrio fibroso; o condrócito ao condrogênico"],
        ...
        {p:"Em quais cartilagens o pericôndrio está ausente?",
         alt:["Nas articulares e na fibrosa","Apenas na cartilagem elástica","Em todas as cartilagens hialinas","Somente nas cartilagens da laringe"],
        ...
        {p:"Onde é encontrada a cartilagem elástica?",
         alt:["Pavilhão auditivo, tuba auditiva e epiglote","Discos intervertebrais e sínfise púbica","Superfícies articulares dos ossos longos do corpo","Apenas no septo nasal"],
        ...
        {p:"Quais características tornam a cartilagem fibrosa intermediária entre o conjuntivo denso e a cartilagem hialina?",
         alt:["Colágeno tipo I, sem pericôndrio, condrócitos em fileiras","Abundância de fibras elásticas e cor amarelada intensa","Presença de um pericôndrio condrogênico bem espesso","Matriz totalmente calcificada por cristais de hidroxiapatita"],
        ...
        {p:"O que é um grupo isógeno ou isogênico na cartilagem?",
         alt:["Condrócitos originados da divisão de uma mesma célula","Um agrupamento de condroblastos no pericôndrio","Uma região de matriz calcificada","Um feixe de fibras colágenas orientadas na mesma direção"],
        ...
        {p:"Qual sal mineral se deposita na calcificação da matriz cartilaginosa?",
         alt:["Hidroxiapatita","Carbonato de sódio","Cloreto de potássio","Sulfato de magnésio"],
        ...
        {p:"O que ocorre na degeneração da cartilagem, processo acelerado com a idade?",
         alt:["Os condrócitos hipertrofiam e morrem","O pericôndrio prolifera e recobre a superfície articular","As fibras elásticas se convertem em colágeno tipo III","A matriz se liquefaz e é absorvida pelos vasos sanguíneos"],
        ...
        {p:"Como se subdivide o pericôndrio?",
         alt:["Em fibroso e condrogênico","Em pericôndrio externo e interno","Em pericôndrio territorial e interterritorial","Em pericôndrio hialino e elástico"],
        ...
        {p:"O que dá firmeza à matriz cartilaginosa?",
         alt:["Colágeno somado a glicosaminoglicanos","A deposição de hidroxiapatita em condições normais","A densidade de condrócitos por milímetro cúbico","A presença de fibras reticulares de colágeno tipo III"],
    ...
    { id:"r4", emoji:"🦴", nome:"Rodada 4 — Tecido ósseo",
      ...
      questoes:[
        ...
        {p:"Qual é a composição do componente orgânico da matriz óssea?",
         alt:["Colágeno tipo I e proteoglicanas","Colágeno tipo II e condronectina","Hidroxiapatita e fosfato de cálcio","Elastina e fibras reticulares"],
        ...
        {p:"O que é o ósteon?",
         alt:["O canal de Havers com suas lamelas concêntricas","O canal transversal que liga dois canais de Havers","A trabécula do osso esponjoso","A camada mais externa do osso compacto"],
        ...
        {p:"Qual é a diferença entre o canal de Havers e o canal de Volkmann?",
         alt:["O de Havers é longitudinal; o de Volkmann, transversal","O de Havers contém medula óssea; o de Volkmann contém cartilagem","O de Havers existe só no osso esponjoso; o de Volkmann só no compacto","O de Havers é revestido por periósteo; o de Volkmann por endósteo"],
        ...
        {p:"Qual é a diferença fundamental entre ossificação intramembranosa e endocondral?",
         alt:["Na endocondral há antes um molde de cartilagem","Na intramembranosa há molde de cartilagem; na endocondral não","A intramembranosa ocorre só no adulto; a endocondral só no feto","A intramembranosa forma osso esponjoso; a endocondral forma apenas osso compacto"],
        ...
        {p:"O que caracteriza o osso primário em relação ao secundário?",
         alt:["É o osso antes da remodelação","É o osso do feto que nunca é substituído","É o osso compacto, em oposição ao esponjoso","É o osso formado exclusivamente por ossificação endocondral"],
        ...
        {p:"O que é a lacuna de Howship?",
         alt:["A depressão escavada pelo osteoclasto","A cavidade onde reside o osteócito","O espaço entre duas lamelas concêntricas","O canal por onde passam vasos no osso compacto"],
        ...
        {p:"O que diferencia macroscopicamente o tecido ósseo compacto do esponjoso?",
         alt:["O compacto é mais denso, com espaços menores","O compacto tem grandes espaços medulares com trabéculas anastomosadas","O compacto fica no interior da epífise e o esponjoso na superfície externa","O compacto não contém osteócitos"],
        ...
        {p:"Quais são as zonas do disco de crescimento, da epífise em direção à diáfise?",
         alt:["Repouso, proliferação, hipertrófica e ossificação","Ossificação, calcificação, hipertrófica, proliferação e repouso","Proliferação, repouso, calcificação, ossificação e hipertrófica","Repouso, calcificação, proliferação, ossificação e hipertrófica"],
    ...
    { id:"r5", emoji:"🧬", nome:"Rodada 5 — Embriologia: gametas e fertilização",
      ...
      questoes:[
        ...
        {p:"Por que se diz que o sexo cromossômico do embrião é sempre definido pelo pai?",
         alt:["O ovócito só dá X; o espermatozoide dá X ou Y","Porque o espermatozoide contribui com mais cromossomos que o ovócito","Porque o ovócito perde seus cromossomos sexuais na segunda meiose","Porque a determinação depende da velocidade do espermatozoide"],
        ...
        {p:"Na gametogênese, quantas células funcionais resultam de uma ovogônia e de uma espermatogônia, respectivamente?",
         alt:["Um ovócito e quatro espermatozoides","Quatro ovócitos e um espermatozoide","Dois ovócitos e dois espermatozoides","Um ovócito e um espermatozoide"],
        ...
        {p:"Que enzimas o acrossoma libera e sobre o que atuam?",
         alt:["Hialuronidase, para a corona, e acrosina, para a zona pelúcida","Lisozima, que rompe a parede celular, e transcriptase reversa","Fertilina e integrina, que promovem a fusão das membranas","Ocludina e caderina, que desfazem as junções celulares"],
        ...
        {p:"O que é a capacitação do espermatozoide?",
         alt:["Alterações de cerca de 7 horas que aumentam a motilidade","A fusão do acrossomo com a membrana plasmática da célula","A redução do número de cromossomos exatamente à metade","A ativação do metabolismo do zigoto logo após a fusão"],
        ...
        {p:"Qual é o bloqueio definitivo à polispermia?",
         alt:["A reação cortical, que modifica a zona pelúcida","A capacitação prévia do espermatozoide","O fechamento mecânico da corona radiata","A liberação do segundo corpúsculo polar"],
        ...
        {p:"O que a onda de cálcio provocada pela entrada do espermatozoide desencadeia no ovócito?",
         alt:["A segunda meiose e o segundo corpúsculo polar","A imediata primeira clivagem em dois blastômeros","A formação imediata da blastocele","A implantação do embrião no endométrio"],
    ...
    { id:"r6", emoji:"🌱", nome:"Rodada 6 — Embriologia: da clivagem à organogênese",
      ...
      questoes:[
        {p:"O que caracteriza a clivagem?",
         alt:["Mitoses sucessivas que aumentam as células sem aumentar o volume","Divisões meióticas que reduzem o número de cromossomos","O crescimento das células sem que elas se dividam","A migração das células para formar os folhetos embrionários"],
        ...
        {p:"Com quantas células o embrião passa a ser chamado de mórula, e quando ela chega ao útero?",
         alt:["16 células, três dias depois","32 células, cerca de sete dias depois","8 células, no mesmo dia da fertilização","64 células, ao fim da segunda semana"],
        ...
        {p:"Qual hormônio é secretado pelo sinciciotrofoblasto e pelo citotrofoblasto, tornando o teste de gravidez positivo ao fim da 2ª semana?",
         alt:["Gonadotrofina coriônica humana","Progesterona ovariana","Relaxina da gestação","Estrogênio placentário"],
        ...
        {p:"Quais são as duas camadas da placa bilaminar do embrioblasto?",
         alt:["Epiblasto e hipoblasto","Trofoblasto e citotrofoblasto","Ectoderma e endoderma definitivos","Âmnio e saco vitelíneo"],
        ...
        {p:"O que marca o início da gastrulação?",
         alt:["O aparecimento da linha primitiva na extremidade caudal","O fechamento do neuroporo anterior","A formação da blastocele","A secreção de gonadotrofina coriônica humana"],
        ...
        {p:"Em que dias ocorrem os fechamentos dos neuroporos anterior e posterior?",
         alt:["25 dias o anterior e 28 dias o posterior","28 dias o anterior e 25 dias o posterior","14 dias e depois 21 dias","42 dias e depois 44 dias"],
        ...
        {p:"Em que duas partes cada somito se diferencia, e o que cada uma origina?",
         alt:["Esclerótomo, para o esqueleto, e dermomiótomo","Epímero e hipômero, que formam respectivamente a derme e o esqueleto","Notocorda e tubo neural","Epiblasto e hipoblasto"],
